...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_CLASSES":(
        #"utils.throttle.UserBurstRateThrottle",
        "utils.throttle.UserSustainedRateThrottle",
    ),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Gateway Python Blockchain Engineer Test',
    'DESCRIPTION': 'Gateway.fm python blockchain engineer assignment test.',
    'VERSION': '1.0.0',
